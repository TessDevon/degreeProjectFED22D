...
export function saveSellItemBuyData(
  ...
  return fetch(`${BASE_URL}/sellingPostItemComments`, {
    ...
    body: JSON.stringify({
      sellingPostItemCommentsDescription: sellingItemBuyDescription,
      sellingpostitemcommentsUserID: sellingItemUnserID,
      sellingPostItemID: sellingItemID,
      userID: id,
      token: token,
    }),
  })
